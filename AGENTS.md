...
`difficulty: Challenge` is a lab attribute and has nothing to do with the **Bobathon** guide site under `/bobathon/`. Earlier drafts used "Challenge Labs" for both; they are separate things.
